...
urlpatterns = [
   ...
   # path('end_service/<uuid:client_id>/', end_service, name='end_service'),
    path('end_service/<uuid:client_id>/', client_end_service, name='client_end_service'),
    ...
    path('get_products_for_client/', get_products_for_client, name='get_products_for_client'),
